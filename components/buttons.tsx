...
export function BlogpostButton(props: BlogpostButtonProps) {
  return (
    ...
    >
      <div className="aspect-[6/8] rounded-xl group-hover:ring-4 transition-all duration-300 ease-in-out ring-offset-4 ring-offset-white dark:ring-offset-slate-900 ring-[#144fff] overflow-hidden relative group/image">
        <img
      ...
      <div className="space-y-2">
        ...
        <p>
          <span className="font-medium text-xl after:transition-all after:duration-200 after:ease-in-out after:h-1 after:bg-white after:absolute after:left-0 relative after:-bottom-2 after:right-[100%] hover:after:right-0">
            Read more
          </span>
        </p>
      </div>
